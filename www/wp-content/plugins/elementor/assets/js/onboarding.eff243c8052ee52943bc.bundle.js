...
function Account() {
  ...
  if (state.isLibraryConnected) {
    pageTexts = {
      firstLine: __('Чтобы получить максимальную отдачу от Elementor, мы поможем вам сделать первые шаги.:', 'elementor'),
      listItems: [__('Установите тему вашего сайта', 'elementor'), __('Дайте своему сайту имя и логотип', 'elementor'), __('Выберите, как начать творить', 'elementor')]
    };
  } else {
    pageTexts = {
      firstLine: __('Чтобы получить максимальную отдачу от Elementor, мы подключим ваш аккаунт.', 'elementor') + ' ' + __('Тогда вы можете:', 'elementor'),
      listItems: [__('Выбирайте из бесчисленного множества профессиональных шаблонов', 'elementor'), __('Управляйте своим сайтом с помощью нашей удобной приборной панели', 'elementor'), __('Участвуйте в форуме сообщества, делитесь и развивайтесь вместе', 'elementor')]
    };
  ...
  var connectFailureCallback = function connectFailureCallback() {
    ...
    setNoticeState({
      type: 'error',
      icon: 'eicon-warning',
      message: __('Упс, соединение не удалось. Попробуйте еще раз.', 'elementor')
    }); // If not connected at onboarding load, handle the data sharing permission after the connect is handled.
    ...
    if ('initial' !== dataSharingAjaxState.status) {
      ...
      if ('success' === dataSharingAjaxState.status && (_dataSharingAjaxState = dataSharingAjaxState.response) !== null && _dataSharingAjaxState !== void 0 && _dataSharingAjaxState.usageDataShared) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Мы не смогли наладить обмен данными. Вы также можете сделать это позже на странице настроек Elementor в панели администратора.', 'elementor')
        });
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    title: __('Вы здесь! Давайте разберемся.', 'elementor'),
    ...
    labelText: __('Станьте суперсотрудником, делясь неконфиденциальными данными.', 'elementor')
  })), !state.isLibraryConnected && /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__already-have-account-text"
  }, /*#__PURE__*/_react.default.createElement("p", null, __('У вас уже есть один?', 'elementor') + ' ', /*#__PURE__*/_react.default.createElement("a", {
...
function GoodToGo() {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    className: "e-onboarding__page-content-section-title"
  }, __('Это - завершение! Что дальше?', 'elementor')), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__page-content-section-text"
  }, __('Существует два способа начать работу с Elementor:', 'elementor')), /*#__PURE__*/_react.default.createElement(_grid.default, {
    container: true,
    alignItems: "center",
    justify: "space-between",
    ...
    imageAlt: __('Нажмите здесь, чтобы создать новую страницу и открыть ее в редакторе Elementor Editor', 'elementor'),
    text: __('Редактирование чистого холста с помощью редактора Elementor Editor', 'elementor'),
    ...
    imageAlt: __('Нажмите здесь, чтобы перейти к библиотеке комплектов Elementor', 'elementor'),
    text: __('Выбирайте из +100 шаблонов или импортируйте свои собственные', 'elementor'),
    link: kitLibraryLink,
...
function HelloTheme() {
  var _useContext = (0, _react.useContext)(_context.OnboardingContext),
    ...
    message: __('Your site’s got Hello theme. High-five!', 'elementor')
      ...
      continueWithHelloThemeText = state.isHelloThemeActivated ? __('След', 'elementor') : __('Продолжить тему Hello', 'elementor'),
  ...
  var onErrorInstallHelloTheme = function onErrorInstallHelloTheme() {
    ...
    setNoticeState({
      type: 'error',
      icon: 'eicon-warning',
      message: __('Возникла проблема с установкой Hello Theme.', 'elementor')
    });
    resetScreenContent();
  };
  ...
  (0, _react.useEffect)(function () {
    ...
    var timeout4 = setTimeout(function () {
      ...
      }, __('Подождите, это может занять минуту...', 'elementor'))));
    }, 4000);
    ...
    var timeout30 = setTimeout(function () {
      ...
      setActionButtonText( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("i", {
        ...
        className: "e-onboarding__action-button-text"
      }, __('Хорошо, теперь мы действительно близки...', 'elementor'))));
    }, 30000);
    ...
    if ('initial' !== activateHelloThemeAjaxState.status) {
      ...
      if ('success' === activateHelloThemeAjaxState.status && (_activateHelloThemeAj = activateHelloThemeAjaxState.response) !== null && _activateHelloThemeAj !== void 0 && _activateHelloThemeAj.helloThemeActivated) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Возникла проблема с активацией Hello Theme.', 'elementor')
        }); // Clear any active timeouts for changing the action button text during installation.
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    title: __('Мы всегда начинаем с Здравствуйте.', 'elementor'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("span", null, __('Каждому сайту WordPress нужна тема. Присоединяйтесь к более чем 1 млн человек, уже использующих тему Hello от Elementor, и создайте свой сайт именно так, как вы хотите.', 'elementor')), /*#__PURE__*/_react.default.createElement("ul", {
    className: "e-onboarding__feature-list"
  }, /*#__PURE__*/_react.default.createElement("li", null, __('Это гибкий, легкий холст', 'elementor')), /*#__PURE__*/_react.default.createElement("li", null, __('Супербыстрое время загрузки', 'elementor')), /*#__PURE__*/_react.default.createElement("li", null, __('И это отлично подходит для SEO', 'elementor')))));
}
...
function SiteLogo() {
  ...
  if (isUploading) {
    ...
    actionButton.text = __('След', 'elementor');
  }
    ...
    if ('initial' !== uploadImageAjaxState.status) {
      ...
      if ('success' === uploadImageAjaxState.status && (_uploadImageAjaxState = uploadImageAjaxState.response) !== null && _uploadImageAjaxState !== void 0 && (_uploadImageAjaxState2 = _uploadImageAjaxState.imageAttachment) !== null && _uploadImageAjaxState2 !== void 0 && _uploadImageAjaxState2.id) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: 'Это не сработало. Попробуйте загрузить ваш файл снова.'
        });
      }
    }
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    title: __('У вас есть логотип? Добавьте его сюда.', 'elementor'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("span", null, __('В противном случае вы можете пропустить этот пункт и добавить его позже.', 'elementor')), file && !showUnfilteredFilesDialog ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    src: file.url,
    alt: __('Логотип потенциального сайта', 'elementor')
    ...
    heading: __('Бросьте изображение сюда', 'elementor'),
    secondaryText: __('or', 'elementor'),
    buttonText: __('Открытая медиатека', 'elementor'),
    ...
    onError: function onError(error) {
      if ('file_not_allowed' === error.id) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Этот тип файла не поддерживается. Попробуйте использовать другой тип файла', 'elementor')
        });
      }
    }
    ...
    confirmModalText: __('Это позволяет Elementor проверять ваши SVG на наличие вредоносного содержимого. Если вы не хотите разрешить это, используйте другой формат изображения.', 'elementor'),
    errorModalText: __('Возникла проблема с включением загрузки SVG. Попробуйте еще раз или используйте другой формат изображения.', 'elementor'),
...
function SiteName() {
    ...
    if ('initial' !== ajaxState.status) {
      ...
      if ('success' === ajaxState.status && (_ajaxState$response = ajaxState.response) !== null && _ajaxState$response !== void 0 && _ajaxState$response.siteNameUpdated) {
        ...
        setNoticeState({
          type: 'error',
          icon: 'eicon-warning',
          message: __('Извините, имя не сохранилось. Попробуйте еще раз или пока пропустите.', 'elementor')
        });
      }
    }
  }, [ajaxState.status]);
  return /*#__PURE__*/_react.default.createElement(_layout.default, {
    ...
    image: elementorCommon.config.urls.assets + 'images/app/onboarding/Illustration_Setup.svg',
    title: __('Теперь давайте дадим название вашему сайту.', 'elementor'),
    actionButton: actionButton,
    skipButton: skipButton,
    noticeState: noticeState
  }, /*#__PURE__*/_react.default.createElement("p", null, __('Так называется ваш сайт на приборной панели WP, и может быть изменен позже из общих настроек - это не URL вашего сайта.', 'elementor')), /*#__PURE__*/_react.default.createElement("input", {
    className: "e-onboarding__text-input e-onboarding__site-name-input",
    type: "text",
    placeholder: "например. Космические шаттлы Эрика",
...
function UploadAndInstallPro() {
  (0, _usePageTitle.default)({
    title: __('Загрузка и установка Elementor Pro', 'elementor')
  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    heading: __('Импортируйте файл плагина Elementor Pro', 'elementor'),
    text: __('Перетащите и бросьте ваш .zip-файл сюда', 'elementor'),
    secondaryText: __('или', 'elementor'),
    buttonText: __('Просмотреть', 'elementor')
  }), noticeState && /*#__PURE__*/_react.default.createElement(_notice.default, {
    noticeState: noticeState
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "e-onboarding__upload-pro-get-file"
  }, __('Не знаете, откуда взять файл?', 'elementor') + ' ', /*#__PURE__*/_react.default.createElement("a", {
    onClick: function onClick() {
      return onProUploadHelpLinkClick();
    },
    href: 'https://my.elementor.com/subscriptions/' + elementorAppConfig.onboarding.utms.downloadPro,
    target: "_blank"
  }, __('Нажмите здесь', 'elementor')))));
}
